...
-- Question No.1: Retrieve All columns in transactions_value table
SELECT *
FROM transactions_value;

-- Question No.2: Retrieve All columns in transactions_volume table
SELECT *
FROM transactions_volume;

-- Question No.3: How many rows contain in transactions_value table?
SELECT
...
-- Question No.4a: Retrieve number of payment systems contained within noncashps_id table
SELECT
...
-- Question No.4b: Ensure that number of payment systems contained in transactions_value table
...
-- Question No.5: What is the overall average of payment systems
...
-- Question No.6: We are also able to convert prior results to obtain the Trillion value
...
-- Question No.7: Prior queries are also capable to extract the overall average
...
-- Question No.8: To convert the number, we can employ query no.6, with denominator modification
SELECT
...
-- Question No.9: How many provinces are included in province_id table?
SELECT
...
-- Question No.10: How many regions are exist in region_id table
SELECT
